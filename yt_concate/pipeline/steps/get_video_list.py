...
class GetVideoList(Step):
    ...
    def __str__(self):
        return '<class GetVideoList: This class is try use api key to get all video links form youtube >' + '\n'
    ...
    def get_all_video_in_channel(self, utils, inputs):
        ...
        while True:
            ...
            try:
                ...
                break
        self.write_video_lind(filepath, video_links)
        return video_links

    def write_video_lind(self, filepath, video_links):
